...
class App extends React.Component {
  ...
  // ! 비회원 로그인 시
  handleNonmemberContent = (location1) => {
    this.setState({ location1 });
  };

  // 비회원 로그인 시 실행
  handleResponseSuccess2 = () => {
    this.handleNonmemberContent();
  };
  ...
  handleChangeLocation1 = async (e) => {
    ...
    if (
      ...
      this.setState({
        location1: changedLocation.data.location,
      });
      console.log(
      ...
      console.log("same location1");
      this.setState({
        isSameLocation1: "이미 선택한 지역입니다",
      });
      console.log(
        "🚀 ~ file: App.js ~ line 315 ~ App ~ handleChangeLocation2= ~ this.state.isSameLocation2",
        this.state.isSameLocation1
      );
    }
  };
  // ! 마이페이지 지역 변경2
  handleChangeLocation2 = async (e) => {
    ...
    if (
      ...
      console.log("same location2");
      this.setState({
        isSameLocation2: "이미 선택한 지역입니다",
      });

      console.log(
        "🚀 ~ file: App.js ~ line 315 ~ App ~ handleChangeLocation2= ~ this.state.isSameLocation2",
        this.state.isSameLocation2
      );
    }
  };
  ...
  handleAddLocation = async (e) => {
    if (this.state.location1 !== e.target.value) {
      const completedAddLoc = await axios.post(
        "https://mayweather24.com/addlocation",
        {
          userId: this.state.userId,
          location: e.target.value,
        },
      ...
      console.log(
        "🚀 ~ file: App.js ~ line 339 ~ App ~ handleAddLocation= ~ completedAddLoc",
        completedAddLoc
      );
      this.setState({
        location2: completedAddLoc.data.location,
      });
    } else {
          ...
          <Route
            ...
            render={() => (
              <Login
                ...
                handleResponseSuccess2={this.handleResponseSuccess2}
              />
            )}
          />
          {/* 마이페이지 */}
          <Route
            ...
            render={() => (
              <Mypage
                ...
                location1={location1}
                location2={location2}
                isSameLocation1={isSameLocation1}
                isSameLocation2={isSameLocation2}
