    ...
    <div className="sign_up_container">
      ...
      <div className="sign_up_box">
        ...
        <div className="sign_up_box_location">
          <input
            className="sign_up_box_input_location_1"
            list="choices"
            placeholder="시, 도로 조회하세요"
            onChange={handleInputValue("city1")}
          />
          <datalist id="choices">
        ...
        <div className="sign_up_box_location">
          <input
            className="sign_up_box_input_location_2"
            list="choices"
            placeholder="시, 도로 조회하세요"
            onChange={handleInputValue("city2")}
          />
          <datalist id="choices">
            <option value="서울">서울</option>
            <option value="인천">인천</option>
